...
public class ICPayRecordingList extends BaseFragment {
    ...
    private void getData(final int before) {
        Net net = new Net(getActivity(), JsonApi.GetICPayByMeterNo);
    ...
    public static Fragment newInstance(String meterNo) {
        ICPayRecordingList list = new ICPayRecordingList();
        list.meterNo = meterNo;
        return list;
    }
...
//            String payTime = MyUtils.getString(temp, "payTime");
        ...
        public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            LogUtil.showLog("temp is " + temp);
            String payTime = MyUtils.getString(temp, "chargeTime");
            week.setText(MyUtils.getWeek(payTime));
            date.setText(MyUtils.getMonthAndDay(payTime));
            money.setText("¥" + MyUtils.getString(temp, "chargeMoney"));
            payNum.setText("交易流水号 : " + MyUtils.getString(temp, "payId"));
            pay.setText("充值方数 : " + MyUtils.getString(temp, "chargeVolume") + "方");
