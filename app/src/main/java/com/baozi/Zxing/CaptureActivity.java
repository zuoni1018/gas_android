 ...
 * @author Baozi
 */
public class CaptureActivity extends MyActivity implements Callback {

    private static final int REQUEST_CODE = 234;
    private static final int REQUEST_CAMERA_WRITE = 123;
    @Bind(R.id.mo_scanner_light)
    TextView moScannerLight;
    @Bind(R.id.mo_scanner_photo)
    TextView moScannerPhoto;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (EasyPermissions.hasPermissions(this, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            EasyPermissions.requestPermissions(this, "扫描条形码需要摄像头,存储和震动权限", REQUEST_CAMERA_WRITE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        }
    }
    ...
    protected void light() {
        ...
        moScannerLight.setSelected(!flag);
    }
    ...
    private void parseRecode(String recode) {
        LogUtil.showLog("recode is " + recode);
